...
function ReviewDetail() {
  ...
  async function commentOnClick(e) {
    ...
    const res = await axiosInstance.post(`/review/category/comment/:id`, body);
    if (res.data) {
      setCommentText("");
      return get();
    }
  ...
  async function commentDelete(e, id) {
    ...
    await axiosInstance.delete(`/review/category/comment/${id}`);
  ...
  async function reviewDelete(e) {
    ...
    const result = await axiosInstance.post(`/review/category/delete`, data);
  ...
  async function get() {
    num.current++;
    const res = await axiosInstance.get(`/review/category/${location.state}`);
    if (!res.data) {
